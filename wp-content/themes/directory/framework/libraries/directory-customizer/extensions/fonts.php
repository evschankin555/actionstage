...
function customizer_library_get_all_fonts() {
	$heading1       = array( 1 => array( 'label' => sprintf( '--- %s ---', __( 'Standard Fonts', 'directory' ) ) ) );
	$standard_fonts = customizer_library_get_standard_fonts();
	$heading2       = array( 2 => array( 'label' => sprintf( '--- %s ---', __( 'Google Fonts', 'directory' ) ) ) );
...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'directory' ),
		'cyrillic'     => __( 'Cyrillic', 'directory' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'directory' ),
		'devanagari'   => __( 'Devanagari', 'directory' ),
		'greek'        => __( 'Greek', 'directory' ),
		'greek-ext'    => __( 'Greek Extended', 'directory' ),
		'khmer'        => __( 'Khmer', 'directory' ),
		'latin'        => __( 'Latin', 'directory' ),
		'latin-ext'    => __( 'Latin Extended', 'directory' ),
		'vietnamese'   => __( 'Vietnamese', 'directory' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'directory' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'directory' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'directory' ),
