...
class LinksPerParagraph extends AbstractOption
{
    ...
    {
        return __( 'For an unlimited number of links per paragraph, set this value to <code>0</code> .', 'internal-links' );
    }
    ...
    public function renderField( $value )
    {
        ...
        echo  '<input type="number" min="0" name="' . self::getKey() . '" id="' . self::getKey() . '" value="' . $value . '"' . (( $multiple_keywords ? ' disabled="disabled"' : '' )) . ' ' . OptionsHelper::getDisabler( $this ) . '  /> ' ;
    }
