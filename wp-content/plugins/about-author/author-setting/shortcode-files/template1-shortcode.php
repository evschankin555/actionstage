...
?>
<?php 
wp_register_style( 'temp1-page-short-style', false );
wp_enqueue_style( 'temp1-page-short-style' );
$css = " ";
ob_start(); ?>
	.menu li a:before {
...
<?php
$css .= ob_get_clean();
wp_add_inline_style( 'temp1-page-short-style', $css ); ?>

<?php 
wp_register_style( 'temp1-page-short-style1', false );
wp_enqueue_style( 'temp1-page-short-style1' );
$css = " ";
ob_start(); ?>
	<?php echo esc_attr($About_me_custom_css); ?>
<?php
$css .= ob_get_clean();
wp_add_inline_style( 'temp1-page-short-style1', $css ); ?>

<h1 id="auther_bio_info"  class="weblizar_auther_bio_info" align="center"><?php esc_html_e($auther_lbl_text); ?>
</h1>
