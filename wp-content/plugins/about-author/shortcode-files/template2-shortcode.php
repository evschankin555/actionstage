<?php 
wp_register_style( 'temp2-post-short-style1', false );
wp_enqueue_style( 'temp2-post-short-style1' );
$css = " ";
...
#Web_lizar_img_<?php echo esc_attr($p_o_s_t); ?> img.web_lizar_image_User {
	<?php echo isset($my_bodr) ? esc_attr($my_bodr) : null ; ?>;
	width:130px;
	height:130px;
...
<?php
 echo esc_attr($About_me_custom_css);
$css .= ob_get_clean();
wp_register_style( 'temp2-post-short-style1', false );
wp_enqueue_style( 'temp2-post-short-style1' );
wp_add_inline_style( 'temp2-post-short-style1', $css ); ?>
...
<div class="web_lizar_main_div" id="Web_lizar_main_<?php echo esc_attr($p_o_s_t); ?>">
	...
	<?php if($followfb !=="" || $followinsta !=="" || $followlinkdln !=="" ||  $followtwit !=="") { ?>
