...
Tags: youtube gallery, youtube playlist, youtube channel, youtube embed, video gallery
...
* [Playlister Theme](https://demo.plugins360.com/automatic-youtube-gallery/theme-playlister/)
* Sidebar Widget

### TRANSLATION READY

Do you speak another language? Want to contribute in a meaningful way to Automatic YouTube Gallery? There's no better way than to help us translate the plugin. This plugin is translation ready and you can [translate](https://plugins360.com/automatic-youtube-gallery/translate-to-your-language/) to your language easy. Once finished, please reach out to us [here](https://plugins360.com/support/) to get your language file included in the core.
...
6. Then, go to the plugin dashboard, configure your "YouTube API Key" as per the instructions given on the page. Save the changes.
...
If nothing works, please describe your issue and submit a ticket on our plugin support forum, you should receive the reply within 24 hours (except Sunday).
...
* Tweak: Automatic advancing to the next video when the video is the last in the page. The "Pagination Type" should be "Load More".
