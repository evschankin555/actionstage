...
define( 'SIMPLE_TOUR_GUIDE_VERSION', '1.0.7' );
...
function simple_tour_guide_scripts_and_styles() {
	...
	wp_enqueue_style( 'simple-tour-guide', plugin_dir_url( __FILE__ ) . 'assets/css/main.css', SIMPLE_TOUR_GUIDE_VERSION );
	...
	$script_params = array(
		...
		'strings'       => array(
			'close'  => __( 'Закрыть', 'simple-tour-guide' ),
			'back'   => __( 'Назад', 'simple-tour-guide' ),
			'next'   => __( 'Далее', 'simple-tour-guide' ),
			'finish' => __( 'Закончить', 'simple-tour-guide' ),
		),
	);
