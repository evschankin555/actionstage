...
No, the scope of this plugin is the site frontend only. If you need to display a tour on the admin pages, you can check the [Custom Welcome Guide](https://wordpress.org/plugins/custom-welcome-guide/) plugin.
